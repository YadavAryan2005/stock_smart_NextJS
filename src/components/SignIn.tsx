...
export async function SignIn() {
  return (
    <div className=' mt-0 fixed min-h-[100vh] z-50 top-0 bg-[#faf8f84f] backdrop-blur-[2px]  flex flex-col w-full p-2 pt-8 md:pt-2 pb-0 lg:min-h-[98vh]  justify-center min-h-[500px]'>
